...
{
    private static readonly counterInterval = 100;

    private paragraphTimerId: any;
    private counterTimerId: any;
    ...
    public readonly componentWillUnmount = () => this.clearTimers();
    ...
    private readonly startTimers = (props: ILoremProps) =>
    {
    ...
    private readonly showNextParagraph = () => this.setState((state, props) =>
    {
    ...
    private readonly updateCountdown = () => this.setState((state) => ({
        countdown: state.countdown - Lorem.counterInterval,
    }))

    private readonly toggleAutoAdvance = () => this.setState((state, props) =>
    {
